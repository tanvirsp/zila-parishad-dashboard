const { RegisterUserService, ViewUserService, LoginUserService, ResetPasswordService, SendOtpService, VerifyOTPService, ChangePasswordService, ProfileService, ProfileUpdateService, AllUsersServices, UserListService, UpdateRoleService } = require("../services/UserServices")
...
exports.UpdateRole = async(req, res) =>{
    const result = await UpdateRoleService(req)
    return res.status(200).json(result)
}
