...
const RegistrationPDF = async(objData, ejsTemplate) =>{
    try {
        ...
        const createPdf = (html, options) => {
            ...
            pdf.create(html, options).toFile(`${__dirname}/../../pdf/${objData.regNumber}.pdf`, (err, res) => {
...
module.exports=RegistrationPDF;