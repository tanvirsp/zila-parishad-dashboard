...
const ResultDetails = () => {
    ...
    const {studentDetails, regNumber, mark, courseDetails, sessionsDetails } = ResultData;
    ...
    return (
        ...
        <section  className="container ">
            <div className="row  bg-white p-5 rounded-3">
                ...
                <div className="col-md-3">
                    <h6>কোর্সের বিষয়:</h6>
                    <h5> <b>  {courseDetails?.name } </b> </h5>
                </div>
                <div className="col-md-2">
                    <h6>প্রাপ্ত নাম্বার:</h6>
                    <h5> <b>   {mark } </b> </h5>
                </div>
                <div className="col-md-2">
                    <h6>সেশন:</h6>
                ...
                <div className="col-md-2">
                    <button onClick={()=>navigate("/result")} className="btn w-100 btn-success">Go Back</button>
