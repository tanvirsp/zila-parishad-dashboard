...
import EditScholarshipSessionModal from "./EditScholarshipSessionModal";

const ScholarshipSessionList = () => {
    
    const [modalShow, setModalShow] = useState(false);
    const [sessionId, setSessionId] = useState("");
    
    const {SessionList, SessionListRequest} = ScholarshipStore()
  ...
  const handleModal = (id)=>{
    ...
    return (
        ...
        <EditScholarshipSessionModal id={sessionId} show={modalShow}  onHide={() => setModalShow(false)} />
        
        </div>
    );
};

export default ScholarshipSessionList;